...
from models.encoder_wrapper import Encoder
...
class VAE(Encoder):
  ...
  def __init__(self, args):
    ...
    self.model_name = 'variational_encoder'
    self.model_weight_name = self.model_name + '.pt'
    self.model_onnx_name = self.model_name + '.onnx'
